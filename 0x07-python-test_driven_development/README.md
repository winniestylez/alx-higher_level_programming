...
Solution: 0-add_integer.py, tests/0-add_integer.txt
...
Solution: 2-matrix_divided.py, tests/2-matrix_divided.txt
...
Solution: 3-say_my_name.py, tests/3-say_my_name.txt
...
Solution: 4-print_square.py, tests/4-print_square.txt
...
Solution: 5-text_indentation.py, tests/5-text_indentation.txt
...
Solution: tests/6-max_integer_test.py
